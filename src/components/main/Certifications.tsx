...
const certificationsData = [
  {
    ...
    description: "Validates proficiency in networking fundamentals, IP services, security, routing, and switching.",
    issued: "Completed",
    links: []
  },
  {
    Image: "",
    title: "Advanced Cloud Training Program",
    description: "Advanced program on cloud computing, virtualization, and cloud architectural patterns by E & ICT Academy, IIT Kanpur.",
    issued: "Completed",
    links: []
  },
  {
    ...
    description: "Comprehensive program on security concepts, threats, network defense, and compliance frameworks by E & ICT Academy, IIT Kanpur.",
    issued: "Completed",
    links: []
  },
  {
    ...
    description: "Foundational training program covering basic cloud models and services by E & ICT Academy, IIT Kanpur.",
    issued: "Completed",
    links: []
  },
  {
    ...
    description: "National level academic certification in Cloud Computing paradigms and models.",
    issued: "Completed",
    links: []
  },
  {
    ...
    description: "Fundamental training program in hardware, software systems, and computing fundamentals by IIT Bombay.",
    issued: "Completed",
    links: []
  }
]
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground mt-2 max-w-3xl mx-auto text-base font-semibold md:text-lg italic">
              Industry-recognized credentials validating my expertise in cloud computing, networking, and security.
            </p>
          </div>
        </motion.div>
