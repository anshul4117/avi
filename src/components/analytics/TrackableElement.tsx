...
export function TrackableButton({ children, ...props }: Omit<TrackableElementProps, 'children'> & { children: ReactElement<any> }) {
  return <TrackableElement {...props}>{children}</TrackableElement>;
}

export function TrackableLink({ children, ...props }: Omit<TrackableElementProps, 'children'> & { children: ReactElement<any> }) {
  return <TrackableElement {...props}>{children}</TrackableElement>;
}

export function TrackableDownload({ fileName, children }: { fileName: string; children: ReactElement<any> }) {
  return (
...
export function TrackableContact({ method, children }: { method: string; children: ReactElement<any> }) {
  return (
...
export function TrackableProject({ projectName, children }: { projectName: string; children: ReactElement<any> }) {
  return (
