  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-amber-500/20 rounded-lg rotate-45 animate-bounce"></div>
        <div className="absolute bottom-32 left-1/4 w-12 h-12 bg-primary/15 rounded-full animate-ping"></div>
        <div className="absolute bottom-20 right-1/3 w-20 h-20 bg-orange-400/10 rounded-lg rotate-12 float-animation"></div>
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-80 h-80 bg-gradient-to-r from-primary/20 via-orange-500/10 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-60 h-60 bg-gradient-to-l from-amber-400/15 via-primary/10 to-transparent rounded-full blur-2xl"></div>
      </div>
      ...
      >
        <h2
          ...
          className="text-4xl sm:text-5xl font-bold tracking-tight bg-gradient-to-r from-foreground via-primary to-amber-500 bg-clip-text text-transparent mb-4"
        >
          Technical Skills
        </h2>
        <p className="text-lg text-muted-foreground font-medium">
          A curated selection of my expertise in Networking, Cloud, and Data Science
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        >
          {skillsToShow.map((skill, index) => (
            ...
            >
              {/* Glow effect */}
              <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-primary/20 via-amber-500/10 to-transparent blur-sm"></div>
        ...
        {uniqueSkills.length > maxItemsToShow && (
          ...
          >
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-r from-primary to-amber-500 hover:from-amber-500 hover:to-primary text-primary-foreground px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
