  ...
  return (
    <section id="contact" className="relative py-20 bg-background text-foreground transition-colors overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute top-60 right-16 w-20 h-20 bg-amber-500/20 rounded-lg rotate-45 animate-bounce"></div>
        <div className="absolute bottom-40 left-1/3 w-16 h-16 bg-primary/15 rounded-full animate-ping"></div>
        <div className="absolute bottom-20 right-1/4 w-24 h-24 bg-orange-400/10 rounded-lg rotate-12 float-animation"></div>
        ...
        >
          <div className="flex flex-col md:flex-row gap-12">
            <motion.div
              ...
              animate="visible"
            >
              <h2 title="Connect With Me" className="text-4xl font-extrabold bg-gradient-to-r from-foreground via-primary to-amber-500 bg-clip-text text-transparent">
                Connect With Me
              </h2>
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">aviral.verma.sardhana@gmail.com</span>
                  <button
                    title="Copy email address"
                    onClick={() => copyToClipboard('aviral.verma.sardhana@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 9389652599</span>
                  <button
                    title="Copy phone number"
                    onClick={() => copyToClipboard('+91 9389652599', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Meerut, Uttar Pradesh, India</span>
                </div>
              </div>
            </motion.div>
